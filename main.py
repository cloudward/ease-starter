...
#
#         visitorsStr = "Total Visitors : " + str(counter)
#
#         self.response.write(visitorsStr)
...
# class googleDocUpload(webapp2.RequestHandler):
#     def post(self):
#         postData = self.request.POST
#         result = ''
#         fileName = postData.get('myFile').filename
#         fileContent = postData.get('myFile').file.read()
#
#         q = MyCredentialsEntity.all()
#         if q.count() > 0:
#             items = q.fetch(1)
...
#                 credentials = AccessTokenCredentials(obj.access_token, obj.user_agent)
#         else:
#             result = "<div style='text-align: center'><h1>Access Token Not Found</h1></div>"
#             self.response.write(result)
#
#         if credentials.access_token_expired is True:
#             result = "<div style='text-align: center'><h1>Access Token is Expired...Please generate new token</h1></div>"
#             self.response.write(result)
#
...
#             "parents": [{
#                             "kind": "drive#fileLink",
#                             "id": "0BwUdnNY9u09zRXVoemx1a1VrTFU"
#                         }]
#         }))
#         parts.append('--' + boundary)
...
#         parts.append('')
#         parts.append(base64.b64encode(fileContent))
#         parts.append('--' + boundary + '--')
#         parts.append('')
#         body = '\r\n'.join(parts)
#
...
#         resultObj = json.loads(response.content)
...
#
#         result += "<br><br>"
#         result += "Link : <a href='" + webContentLink + "'>" + webContentLink + "</a>"
#         result += "<br><br>"
#         result += "Link : <img src='" + webContentLink + "' />"
#
#         self.response.write(result)
#
...
#     def get(self):
#
#         if self.session.get('myCounter'):
#             self.response.out.write('Session is in place ')
#             myCounter = self.session.get('myCounter')
#             self.session['myCounter'] = myCounter + 1
#             self.response.out.write('myCounter = ' + str(self.session.get('myCounter')))
#         else:
#             self.response.out.write('Fresh Session')
#             self.session['myCounter'] = 1
#             self.response.out.write('myCounter = ' + str(self.session.get('myCounter')))
#
#
        ...
        # to_addr = "mtl.golakiya@gmail.com"
        #
        #
        #
        # message = mail.EmailMessage()
        # message.sender = "etelos.dev@avinashi.com"
        # message.to = to_addr
...
# class testUpdate(webapp2.RequestHandler):
#     def get(self):
#         # dbObj = datastore.Entity(kind="testObject")
#         # dbObj["id"] = 12345
#         # dbObj["imageName"] = "TestImage.jpg"
#         # dbObj["imageURL"] = "http://www.google.com"
#         # dbObj["imageId"] = "abcd12345"
#         # datastore.Put(dbObj)
#
#         dbObj = datastore.Query("testObject", {"id": 12345})
#         dbObj.Run()
#         count = dbObj.Count()
#         if count > 0:
#             recordsList = dbObj.Get(count)
#             record = recordsList[0]
#             record["imageURL"] = "http://www.yahoo.com"
